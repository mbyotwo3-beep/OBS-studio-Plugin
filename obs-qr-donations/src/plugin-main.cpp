...
bool obs_module_load(void) {
  blog(LOG_INFO, "[QR Donations] Plugin loaded successfully (version %s)",
       "1.0.0");
...
const char *obs_module_name() { return "QR Donations"; }

const char *obs_module_description() {
  return "Displays QR codes for receiving Bitcoin donations (on-chain and "
         "Lightning via Breez)";
}
